...
import com.github.pires.obd.reader.commands.ActuatorPedalPositionCommand;
import com.github.pires.obd.reader.commands.BoostPressureControlCommand;
import com.github.pires.obd.reader.commands.CommandedEgrCommand;
import com.github.pires.obd.reader.commands.EgrErrorCommand;
...
public final class ObdConfig {
    ...
    public static ArrayList<ObdCommand> getCommands() {
        ...
        cmds.add(new BoostPressureControlCommand());
        cmds.add(new ActuatorPedalPositionCommand("49"));
        cmds.add(new ActuatorPedalPositionCommand("4A"));
        cmds.add(new ActuatorPedalPositionCommand("4B"));
